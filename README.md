...
<p align="center">
  ...
  开源、自托管的视觉素材管理系统：收集、整理、检索和迁移你的图片与视频素材。
</p>

<p align="center">
  <sub>个人数字资产管理（DAM） · Eagle 素材库迁移 · 网页图片采集 · 桌面端与 Web 端 · 本地 AI 标签</sub>
</p>
...
<p align="center">
  <a href="#产品组成">产品组成</a> ·
  <a href="#为什么选择-sekereagle">为什么选择</a> ·
  <a href="#功能一览">功能</a> ·
  <a href="#快速开始">快速开始</a> ·
...
SekerEagle 面向设计师、开发者和视觉内容收藏者，是一套可自行部署的开源图片与视频素材库。
如果你正在寻找 **Eagle 替代方案或迁移出口**、**自托管图片管理工具**、**设计灵感库**或
**个人数字资产管理（DAM）系统**，它提供了一条从网页采集、Eagle 迁移到长期整理和检索的完整路径。

| 你关心的事             | SekerEagle 的选择                                                    |
| ---------------------- | -------------------------------------------------------------------- |
| 数据是否真正属于自己   | 原文件与元数据保存在自己的 PostgreSQL 和 MinIO 中，默认没有遥测      |
| 能否从 Eagle 平稳迁移  | 不可变快照、预检、断点续传、幂等重放和迁移后核验                     |
| 大型素材库是否好用     | 瀑布流、组合筛选、智能文件夹、后台媒体处理与十万条元数据性能基线     |
| 是否被 AI 或云服务绑定 | AI 标签建议完全可选，可在 Apple Silicon 上本地运行，核心功能不依赖它 |
